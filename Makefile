...
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/Device/sunplus/sp7350/Include
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/Device/sunplus/sp7350/Source/gcc
CCFLAGS += -I$(TOP)/system/drivers/CMSIS/CMSIS/Core_CM4/Include

#HAL header files
CCFLAGS += -I$(TOP)/system/drivers/sp7350_hal_driver/inc
CCFLAGS += -I$(TOP)/system/sp7350

#libraries srcwarpper header files for Arduino Framework
CCFLAGS += -I$(TOP)/system/drivers/sp7350_hal_driver/src
...
CCFLAGS += -I$(TOP)/cores/arduino/sunplus/LL
CCFLAGS += -I$(TOP)/variants/sp7350_evb

# C Sources Files Directory
#DIRS += $(TOP)/system/sp7350
