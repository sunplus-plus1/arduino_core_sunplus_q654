...
#define TFT_CS   82  // Chip select control pin D8
#define TFT_DC   83  // Data Command control pin
#define TFT_RST  81  // Reset pin (could connect to NodeMCU RST, see next line)
...
#define TOUCH_CS 85     // Chip select pin (T_CS) of touch screen
